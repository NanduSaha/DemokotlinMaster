...
class FeaturedListAdapter(private val mValues: List<Featured>, val listener: FeaturedListListner) :
    RecyclerView.Adapter<FeaturedListAdapter.ViewHolder>() {


    private var listListner: FeaturedListAdapter.FeaturedListListner? = null
    internal lateinit var ctx: Context



    interface FeaturedListListner {
        fun onItemClickFeature(sCatId: String, pId: String)
    }


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeaturedListAdapter.ViewHolder {
        ctx = parent.context
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
      ...
      //  holder.tvItemTitle!!.setText(mDataBean.p_img[0])
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        open fun bindView(context: Context, listener: FeaturedListListner)
        {
            ...
            llMain!!.setOnClickListener(View.OnClickListener { listener.onItemClickFeature(tvCartId!!.text.toString(), tvProductId!!.text.toString())})
        }
